<script lang="ts">
	...
	import { NewspaperIcon, UsersIcon, MailIcon, LayoutDashboardIcon } from "@lucide/svelte";
...
<Sidebar collapsible="offcanvas">
	<SidebarHeader class="border-b border-sidebar-border h-14 flex-row items-center px-4">
		<div class="flex items-center gap-2">
				<img src="/logomain.svg" class="w-16 h-16" alt="">
	...
	<SidebarFooter class="border-t border-sidebar-border h-14 flex-row items-center px-4">
		<div class="flex items-center gap-2 text-xs">
			<div class="size-8 rounded-full bg-linear-to-br from-primary to-primary/60 flex items-center justify-center text-primary-foreground font-bold">A</div>
